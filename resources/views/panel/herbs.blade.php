        ...
        <tr>
            ...
            <td style="text-align: center;">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-6">
                            <form action="{{url('/adminpanel/deleteHerb/'.$item->id)}}" method="post">
                                @csrf
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addModalLabel">Add Herb</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="{{url('/adminpanel/addHerb')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-4">
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editModalLabel">Update Herb</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<script>
    ...
    var showEditModal = function(type){
        ...
        $("#editName").val(name)
        $("#editModalForm").attr("action", `/adminpanel/updateHerb/${id}`)
